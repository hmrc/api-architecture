...
```json
{
  "employments": [
    {
      "id": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
      "employerName": "Wibble Inc"
    },
    {
      "id": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
   ...
   "stateBenefits": [
    {
      "id": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
      "payeRef" : "123/JSA",
      "benefitName": "JSA", //Need to check where this comes from etc
      "startDate": "", //Mandatory ??
      "cessationDate": "" //optional
    }
  ],
   "customerDeclaredStateBenefits": [
    {
      "id": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
      "payeRef" : "123/JSA",
      "benefitName": "JSA", //Need to check where this comes from etc
  ...
  "customerDeclaredEmployments": [
    {
      ...
      "startDate": "2000-01-01",
      "cessationDate": "2001-01-01",
      "createdOn": "2020-03-03T01:01:01Z",
      "deletedOn": "2020-03-05T01:01:01Z",
      "history": [
        {
          "employmentId": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
          "employerName": "Wibble Inc",
          "submittedOn": "2020-03-05T01:01:01Z"
        },
        {
          "employmentId": "960b4a0f-05f2-4b6f-9b87-c3e001a84472",
          "employerName": "Wobble Inc",
...
{
  "stateBenefit": {
      "taxableAmount": 123.00, // Mandatory #moneyPositive
      "taxPaid":  123.00       // Optional  #moneyNegative or #moneyPositive
    }
}
```
...
| 15   | How do we provide in-year state benefits figures? (DWP only provides information at the end of the year/claim) | Stuart Mckeown |  |
| 16   | Consider implications to messaging/warnings in the calculator to advise about customer submitted in-year state benefits | | 
...
| 21   | BVR(s) to allow state-benefit submissions in-year.  DWP figures to override customer submitted values.  Post crystalisation DWP updates treated as an amendment. | Customers need to be able to assert benefit values to get an accurate calculation |   |
| 22   | History data to be ordered by submission date in descending order |  |   
